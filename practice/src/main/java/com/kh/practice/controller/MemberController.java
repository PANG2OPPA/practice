...
import com.kh.practice.dto.MemberDto;
import com.kh.practice.service.MemberService;
...
public class MemberController {
    ...
    // 회원 등록
    @PostMapping("/new")
    public ResponseEntity<Boolean> memberResister(@RequestBody MemberDto memberDto) {
